...
import 'package:flutter_mastery/theme/bloc_theme/theme_event.dart';
import 'package:flutter_mastery/theme/bloc_theme/theme_state.dart';
import 'package:flutter_mastery/theme/theme_servicse/theme_cached.dart';
  ...
  ThemeBloc() : super(ThemeInitial()) {
    on<ThemeEvent>((event, emit) {
      if (event is GetThemeEvent) {
        ...
        var themeData =
            AppTheme.values.firstWhere((element) => element.index == theme);
